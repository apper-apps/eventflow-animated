...
const LogoutButton = () => {
  ...
  return (
    <button 
      onClick={logout}
      className="flex items-center gap-2 p-1.5 sm:p-2 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors touch-manipulation"
      title="Logout"
    >
      <ApperIcon name="LogOut" size={18} className="sm:w-5 sm:h-5" />
